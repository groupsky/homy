 ...
 * @return {Array<number>}
 */
const writeLongBig = (value) => [value >> 16, value & 0xFFFF]
...
async function read(
    ...
    if (config) {
        ...
        // Display mode
        result.display_mode = data.data.slice(6, 9).map(v => ('0'.repeat(3)+v.toString(16)).slice(-4)).join('')
