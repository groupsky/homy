 ...
 *
 * This is a copy of `docker/automations/lib/payload-preview.js`. The two services
 * are separate npm packages with separate `node_modules`, so the module cannot be
 * shared by `require`; the behaviour is kept identical and
 * `payload-preview.test.js` is the same suite.
 */
