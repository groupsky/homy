...
REQUIRED_VARS="ZIGBEE2MQTT_CONFIG_SERIAL_PORT ZIGBEE2MQTT_CONFIG_ADVANCED_NETWORK_KEY ZIGBEE2MQTT_CONFIG_MQTT_BASE_TOPIC ZIGBEE2MQTT_CONFIG_MQTT_SERVER ZIGBEE2MQTT_CONFIG_FRONTEND_AUTH_TOKEN"
